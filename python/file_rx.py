...
"""
This application samples a signal and writes complex baseband data to
file. The signal can be filtered and gated with a power squelch.
"""
...
def main():
    ...
    parser.add_option("-g", "--gain", type="int", default=50, help="set RF gain", metavar="dB")
    parser.add_option("-i", "--input", type="string", default=None, help="the input file")
    parser.add_option("-l", "--low-pass", type="eng_float", default=0, help="low pass cut-off", metavar="Hz")
    parser.add_option("-o", "--output", type="string", default=None, help="the output file")
